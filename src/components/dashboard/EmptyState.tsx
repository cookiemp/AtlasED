  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-8 py-6">
      <div className="relative mb-6">
        ...
        <div className="w-36 h-36 rounded-3xl bg-atlas-bg-secondary border border-atlas-border map-pattern flex items-center justify-center">
          <div className="w-16 h-16 rounded-2xl bg-atlas-gold/10 border border-atlas-gold/30 flex items-center justify-center glow-gold">
            <Compass className="w-8 h-8 text-atlas-gold" />
          </div>
        </div>
        {/* Floating Elements */}
      ...
      <h2 className="font-display font-bold text-2xl text-atlas-text-primary mb-2 text-center">
        No Expeditions Yet
      </h2>
      <p className="text-atlas-text-secondary text-center max-w-md mb-6 leading-relaxed">
